                    ...
                    <tbody>
                      {payrollRecords.map(payslip => (
                        <tr key={payslip._id} id="search-item">
                          ...
                          <td><span>LKR</span>{formatMoney(payslip.basic)}</td>
                          <td><span>LKR</span>{formatMoney(payslip.grossEarning)}</td>
                          <td><span>LKR</span>{formatMoney(payslip.consolidationRelief)}</td>
                          <td><span>LKR</span>{formatMoney(payslip.pension)}</td>
                          <td><span>LKR</span>{formatMoney(payslip.taxableIncome)}</td>
                          <td><span>LKR</span>{formatMoney(payslip.tax)}</td>
                          <td><span>LKR</span>{formatMoney(payslip.netPay)}</td>
                        </tr>
                      ))}
                      <tr>
                        <td><strong>Total Sum</strong></td>
                        <td><strong><span>LKR</span>{formatMoney(basicSum)}</strong></td>
                        <td><strong><span>LKR</span>{formatMoney(grossSum)}</strong></td>
                        <td><strong><span>LKR</span>{formatMoney(cRSum)}</strong></td>
                        <td><strong><span>LKR</span>{formatMoney(pensionSum)}</strong></td>
                        <td><strong><span>LKR</span>{formatMoney(taxableIncomeSum)}</strong></td>
                        <td><strong><span>LKR</span>{formatMoney(taxPayableSum)}</strong></td>
                        <td><strong><span>LKR</span>{formatMoney(monthlyNetPaySum)}</strong></td>
                      </tr>
                    </tbody>
                  </table>
                </div>
