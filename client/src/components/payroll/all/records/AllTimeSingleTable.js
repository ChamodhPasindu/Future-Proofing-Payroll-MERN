...
const AllTimeSingleTable = ({ payroll }) => {
          ...
          <table className="table table-striped" border="2">
            <tbody>
              ...
              <tr>
                <td>
                  Employee Name:{" "}
                  <strong className="ml-2">{payroll.name}</strong>
                </td>
                <td>
                  Tax Year:{" "}
              ...
              <tr>
                <td>
                  Employee Tag: <strong className="ml-5">{payroll.tag}</strong>
                </td>
                <td>
                  Pay Period:{" "}
              ...
              <tr>
                <td>
                  Designation:{" "}
                  <strong className="ml-5">{payroll.designation}</strong>
                </td>
                <td>
                  Department:{" "}
                  <strong className="ml-5">{payroll.department}</strong>
                </td>
              </tr>
              <tr>
                <td>
...
AllTimeSingleTable.propTypes = {
    payroll: PropTypes.object.isRequired
}

export default AllTimeSingleTable;
